...
if(feature_txt_files[i]==NULL) {
LOG(INFO) << "Error in FILE open.";
}
}
...
fprintf(feature_txt_files[i], "%.6f ", feature_blob_data[d]);
        }
fprintf(feature_txt_files[i], "\n");
        string value;
